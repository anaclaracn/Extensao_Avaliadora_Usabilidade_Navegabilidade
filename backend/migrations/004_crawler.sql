-- ============================================================
-- MIGRATION v5 — Crawler de sites (com detecção de templates)
...
CREATE INDEX IF NOT EXISTS idx_crawler_queue_pattern   ON crawler_queue(crawler_session_id, url_pattern);
